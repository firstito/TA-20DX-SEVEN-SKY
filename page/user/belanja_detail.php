  ...
  <table class="article">
    <tr>
      ...
      <td>
        ...
        <img src="img/laptop/<?php echo $row->nama_image ?>" width="100"><br><br>
      </td>
    </tr>
<!-- code by muh iriansyah putra pratama -->
    <tr>
    ...
    <tr>
      ...
      <td>
        <select name="bonus">
          ...
          <option value="Pelindung Keyboard">Pelindung Keyboard</option>
          <option value="Pembersih Layar">Pembersih Layar</option>
          <option value="Kain Fiber">Kain Fiber</option>
