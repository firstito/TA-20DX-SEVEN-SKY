...
// code by muh iriansyah putra pratama
    ...
    try {
      ...
      $insert = $conn->prepare("INSERT INTO tbl_pesanan (id_user,id_barang,bonus,qty,kurir,date_in,total) SELECT id_user,id_barang,bonus,qty,kurir,date_in,total FROM tbl_keranjang WHERE id_user=:id");
  ...
  <table class="article">
    ...
    <tr>
      ...
      <td>
        ...
        A.N : Firstito Rahman Abdillah<br>
        Referensi : bayar/id user/laptop <b>contoh : bayar/<?php echo $id."/laptop"; ?></b>
      </td>
    </tr>
    <tr>
      <td>Lanjutan</td>
    ...
    <tr>
      <td></td>
      <td>
        Terima kasih telah membeli laptop di website kami <br>
